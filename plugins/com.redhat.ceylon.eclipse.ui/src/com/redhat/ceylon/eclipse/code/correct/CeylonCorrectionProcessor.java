...
import static com.redhat.ceylon.eclipse.code.correct.JoinIfStatementProposal.addJoinIfStatementProposal;
...
public class CeylonCorrectionProcessor extends QuickAssistAssistant 
    ...
    private void addProposals(IQuickAssistInvocationContext context, 
        ...
        if (rootNode!=null) {
            ...
            addJoinIfStatementProposal(proposals, doc, file, statement);
